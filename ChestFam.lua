...
button.Position = UDim2.new(0.1, 0, 0.16, 0)
...
stroke.Color = Color3.fromRGB(255, 255, 255) -- màu ban đầu

-- Đổi màu viền rainbow
task.spawn(function()
	while true do
		for h = 0, 1, 0.01 do
			stroke.Color = Color3.fromHSV(h, 0.5, 1)
			task.wait(0.03)
		end
	end
end)
