...
local v15 = v14:CreateWindow({
    Title = "AnDepZai Hub",
    SubTitle = "Revived by @hnc_roblox With @hnc_roblox2",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
v16.Home:AddButton({
    Title = "Discord",
    Description = "Nơi Sẵn Lòng Chào Đón Bạn",
    Callback = function()
        setclipboard("https://discord.gg/Zgbc5kyet9");
    end
});
v16.Home:AddButton({
    Title = "Công Cụ Bay",
    Description = "",
    Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/hnc-roblox/Hgd/refs/heads/main/FlyGuiV3.txt"))()
    end
});
v16.Home:AddButton({
Title = "Công Cụ TP",
    Description = "",
    Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/hnc-roblox/TP/refs/heads/main/TP"))()
    end
});
v16.Home:AddButton({
Title = "Tốc Độ",
    Description = "",
    Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/hnc-roblox/Speed/refs/heads/main/SpeedHNC.lua"))()
    end
});
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("Trạng Thái: " .. tostring(v768) .. " Xương");
            end
        end);
    end);
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Teleport Cửa Trial Tộc Draco",
    Description = "",
    Default = false
});
